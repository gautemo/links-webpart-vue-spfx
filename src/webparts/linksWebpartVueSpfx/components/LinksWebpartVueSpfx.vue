<template>
    <div :class="$style.LinksWebpartVueSpfx">
 ...
 */
export interface ILinksWebpartVueSpfxProps {
    description: string;
}
 ...
 */
@Component
export default class LinksWebpartVueSpfx extends Vue implements ILinksWebpartVueSpfxProps {
